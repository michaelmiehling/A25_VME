-- Generated by IP Compiler for PCI Express 11.0 [Altera, IP Toolbench 1.3.0 Build 208]
-- ************************************************************
...
ARCHITECTURE SYN OF hard_ip_x1_core IS
	...
	GENERIC (
		...
		bar3_io_space	: STRING;
		bar3_64bit_mem_space	: STRING;
		bar3_prefetchable	: STRING;
		bar3_size_mask	: NATURAL;
		bar4_io_space	: STRING;
		bar4_64bit_mem_space	: STRING;
		bar4_prefetchable	: STRING;
		bar4_size_mask	: NATURAL;
		bar5_io_space	: STRING;
		bar5_64bit_mem_space	: STRING;
		bar5_prefetchable	: STRING;
		bar5_size_mask	: NATURAL;
...
BEGIN
	...
	GENERIC MAP (
		...
		bar4_size_mask => MEN_SIZE_MASK_BAR_4, --,
